...
const BannerOne = () => {
  return (
    <>
      ...
      >
        <img className="animate-img-1 top_image_bounce" src="assets/img/banner/2.png" alt="img" />
        <img className="animate-img-2 left_image_bounce" src="assets/img/banner/5.svg" alt="img" />
            ...
            <div className="col-lg-6 align-self-center">
              <div className="banner-inner pe-xl-5">
                ...
                <p
                  ...
                  data-aos-duration="1500"
                >
                  And In Order To Make A Business, Brand Advertising And Marketing Plays An
                  Important Role. Similarly, In Making Cultivation Business Are Necessary.
                </p>
                <Link
            ...
            <div className="col-xl-4 col-lg-5 col-md-8 offset-xl-2 offset-lg-1">
              ...
              >
                ...
                <img
                  ...
                  alt="img"
                />
                <img className="main-img" src="assets/img/banner/1.png" alt="img" />
              </div>
            </div>
          </div>
        </div>
