          ...
          <div className="row">
            ...
            >
              <div className="about-thumb-inner">
                <img
                  ...
                  alt="img"
                />
                <img className="main-img" src="assets/img/about/21.png" alt="img" />
              </div>
            </div>
            <div
              className="col-lg-6"
            ...
            >
              <div className="section-title mb-0 ps-xl-5">
                ...
                <h2 className="title">Experience intelligence like never before</h2>
                ...
                <Link className="btn btn-base-color border-radius-5" to="/about">
                  Discover More
                  <FaArrowRight />
                </Link>
              </div>
