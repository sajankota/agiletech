          ...
          <div className="row">
            <div className="col-lg-4 col-md-6">
              <div className="single-blog-list">
                <div className="thumb">
                  <img className="border-radius-5" src="assets/img/blog/4.png" alt="img" />
                ...
                <div className="details">
                  ...
                  <h5 className="mb-4">
                    <Link to="/blog-details">Transforming businesses, one pixel at a time</Link>
                  </h5>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-blog-list">
                <div className="thumb">
                  <img className="border-radius-5" src="assets/img/blog/5.png" alt="img" />
                ...
                <div className="details">
                  ...
                  <h5 className="mb-4">
                    <Link to="/blog-details">The Importance of a Strong Digital for Strategy</Link>
                  </h5>
                  <Link className="btn btn-border-base" to="/blog-details">
                    Read More
                    <FaArrowRight />
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-blog-list">
                <div className="thumb">
                  <img className="border-radius-5" src="assets/img/blog/6.png" alt="img" />
                  <p className="date">31 December,2022</p>
                </div>
                <div className="details">
                  <ul className="blog-meta p-0">
                  ...
                  <h5 className="mb-4">
                    <Link to="/blog-details">Creating Engaging Content: A Guide for Digital</Link>
                  </h5>
                  <Link className="btn btn-border-base" to="/blog-details">
                    Read More
                    <FaArrowRight />
