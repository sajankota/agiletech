              ...
              <div className="blog-details-page-content">
                <div className="single-blog-inner">
                  ...
                  <div className="details">
                    ...
                    <p>
                      Cras varius. Donec vitae orci sed dolor rutrum auctor. Fusce egestas elit eget
                      lorem. Suspendisse nisl elit, rhoncus eget elementum acondimentum eget, diam.
                      Nam at tortor in tellus interdum sagitliquam lobortis. Donec orci lectus,
                      aliquam ut, faucibus non, euismod id, nulla. Curabitur blandit mollis lacus.
                      Nam adipiscing. Vestibulum eu odio. Vivamus laoreet.
                    </p>
                    <p>
                      Lorem available market standard dummy text available market industry Lorem
                      Ipsum simply dummy text of free available market.There are many variations of
                    ...
                    <blockquote>
                      <FaQuoteRight />
                      <p>
                        sollicitudin nisi nulla eget augue. Maecenas quis turpaliquet, portorem et,
                        dictum purus. Cdimentfermentposuere world class service provider
                      </p>
                ...
                <div className="blog-admin media">
                  <div className="media-left pe-3">
                    <img className="avatar" alt="img" src="assets/img/about/8.png" />
                  </div>
                      ...
                      <article className="comment-body">
                        <footer className="comment-meta">
                          <div className="comment-author vcard">
                            <img className="avatar" alt="img" src="assets/img/about/7.png" />
                    ...
                    <li className="comment">
                      <article className="comment-body">
                        <footer className="comment-meta">
                          <div className="comment-author vcard">
                            <img className="avatar" alt="img" src="assets/img/about/7.png" />
                            <a href="http://example.org/" rel="external nofollow" className="url">
                              John Κώστας Doe Τάδε
                            </a>
                            <span className="says">says:</span>
                          </div>
                ...
                <form className="blog-comment-form">
                  ...
                  <div className="row">
                    ...
                    <div className="col-12">
                      <button type="submit" className="btn btn-base border-radius-5">
                        Post Comment
                      </button>
                    </div>
                  </div>
                  ...
                  <ul>
                    <li>
                      <div className="media">
                        ...
                        <div className="media-body align-self-center">
                          <h6 className="title">
                            <Link to="/blog-details">Empowering future with solar.</Link>
                          </h6>
                    ...
                    <li>
                      <div className="media">
                        ...
                        <div className="media-body align-self-center">
                          <h6 className="title">
                            <Link to="/blog-details">Marketing For Base market watch</Link>
                          </h6>
                          <div className="post-info">
                            <FaCalendarAlt />
                            <span>15 October</span>
                    ...
                    <li>
                      <div className="media">
                        ...
                        <div className="media-body align-self-center">
                          <h6 className="title">
                            <Link to="/blog-details">Condtum Integer urna at faucibus</Link>
                          </h6>
                          <div className="post-info">
                            <FaCalendarAlt />
                            <span>15 October</span>
