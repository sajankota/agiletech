          ...
          <div className="row justify-content-center">
            <div className="col-lg-6">
              <div className="section-title text-center pb-5">
                ...
                <h2 className="title">Empowering Your Business With Artificial</h2>
              </div>
            </div>
          </div>
            ...
            <div className="row">
              <div className="col-lg-3 col-md-6">
                <div className="single-work-process-inner style-2 text-center">
                  <img className="line-img" src="assets/img/about/29.png" alt="img" />
              ...
              <div className="col-lg-3 col-md-6">
                <div className="single-work-process-inner style-2 text-center">
                  <img className="line-img" src="assets/img/about/30.png" alt="img" />
                  <div className="thumb mb-3">
