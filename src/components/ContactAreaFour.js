          ...
          <div className="row">
            ...
            >
              <div className="about-thumb-inner ms-xl-5 p-xl-5 pt-4 ">
                <img className="animate-main-img" src="assets/img/about/18.png" alt="img" />
                <img className="main-img m-4" src="assets/img/about/19.png" alt="img" />
              </div>
            </div>
            <div
            ...
            >
              <div className="section-title mb-0 mt-5 mt-lg-0">
                ...
                <p className="content">
                  For your car we will do everything advice design in us repairs and maintenance. We
                  are the some preferred.
                </p>
                <form className="mt-4">
                  <div className="row">
