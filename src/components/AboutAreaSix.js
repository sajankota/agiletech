            ...
            <div className="row">
              <div className="col-lg-6">
                ...
                >
                  <img
                    ...
                    alt="img"
                  />
                  <img className="main-img" src="assets/img/about/23.png" alt="img" />
                  <a
              ...
              >
                <div className="section-title mt-5 mt-lg-0 mb-0">
                  ...
                  <p className="content">
                    Aliquam eros justo, posuere in lobortis non, viverra laoreet augue. Sed des
                    mattisi fermentum ullamcorper risus sollicitudin vel. Fusce nec egestas leo
                    mattis oui fermentum dui.
                  </p>
                  <p className="small-title">
                    Vestibulum molestie pharetra dictum Integer interdum gravida urna sed fringilla
                    dolor maximus.
                  </p>
                    ...
                    <div className="col-md-4">
                      <div className="image-hover-rotate border-1 p-4 border-radius-5 text-center">
                        <div className="thumb mb-3">
                          <img className="rotate-img" src="assets/img/about/25.png" alt="img" />
                        </div>
