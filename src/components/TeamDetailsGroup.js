            ...
            <div className="row">
              ...
              <div className="col-lg-7 align-self-center ps-xl-5">
                ...
                <div className="details mt-4">
                  <h4>About Me</h4>
                  <p>
                    Fox nymphs grab quick-jived waltz. Brick quiz whangs jumpy veldt fox. Bright
                    vixens jump; dozy fowl The quick, brown fox jumps over a lazy dog.
                  </p>
                  <p>
                    DJs flock by when MTV ax quiz prog. Junk MTV quiz graced by fox whelps. Bawds
                    jog, flick quartz, vex nymphs. Waltz, bad nymph, for quick jigs vex! Fox nymphs
                    grab quick-jived waltz. Brick quiz whangs jumpy veldt fox. Bright vixens jump;
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-service-inner text-center">
                ...
                <div className="details">
                  ...
                  <p>
                    Lorem is Ipsum is simply is design iomyi is text Lorem Ipsum is simply is our
                    busi Lorem is Ipsum is
                  </p>
