                ...
                <div className="career-wrap">
                  <div className="row">
                    ...
                    <div className="col-lg-7">
                      ...
                      <p className="mb-3">
                        A software company is a business that designs, develops, and sells software
                        products to individuals and organizations. These companies use a variety of
                        programming languages and technologies to create custom software solutions
