          ...
          <div className="container">
            <div className="footer-subscribe-inner box-shadow style-2 bg-white p-0 bg-cover">
              ...
              <div className="row align-self-center">
                ...
                <div className="col-lg-4">
                  <a className="btn w-100 btn-black sky border-radius-0" href="/#">
                    Submit now
                  </a>
                </div>
              </div>
                    ...
                    <div className="media">
                      <div className="media-body align-self-center">
                        ...
                        <h6 className="title sky mb-0">
                          <Link to="/blog-details">Social Media For Promote Business.</Link>
                        </h6>
                      </div>
                    </div>
                  </li>
                  <li className="sky">
                    <div className="media">
                      <div className="media-body align-self-center">
                        ...
                        <h6 className="title sky mb-0">
                          <Link to="/blog-details">Marketing For Base marketing watch</Link>
                        </h6>
                      </div>
                    </div>
                  </li>
